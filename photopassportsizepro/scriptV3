...
document.addEventListener('DOMContentLoaded', function () {
  // Wait for auth verification before initializing
  document.addEventListener('auth-verified', (e) => {
    console.log('Auth verified for user:', e.detail.email);
    initializeApp();
  });

  // Also initialize if body is already visible (for non-protected pages)
